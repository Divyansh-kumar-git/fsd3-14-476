...
6. type in terminal `npm i nodemon -D` to install nodemon, hwich restarts server while file changes. -D flag indicate install in dev dependency
7. it creates node_modules folder and package-lock.json
8. update .gitignore file and write project-folder/node_modules
9. update package.json to run the project, upadte script property as below
